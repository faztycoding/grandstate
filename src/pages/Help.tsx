        ...
        <MachinePanel>
          <div className="p-4 sm:p-6">
            ...
            <Accordion type="single" collapsible className="w-full">
              {(isEn ? [
                { q: 'How many groups can I post to per day?', a: 'Rookie (Free): 10/day · Top Agent: 300/day · Elite: 750/day. Limits reset at 5:00 AM daily. See the Pricing page for full details.' },
                { q: 'How does AI Caption work?', a: 'Claude AI generates a unique Thai caption for each group — includes property details, price, location, and hashtags. No two posts are identical, reducing spam detection risk. No API key setup needed.' },
                { q: 'Is my Facebook account safe?', a: '6-layer Anti-Detection: human-like delays, mouse/scroll simulation, browser fingerprint masking, per-user session isolation, cookie management, and viewport randomization. Health Check monitors your safety score and recommends safe posting frequency.' },
              ] : [
                { q: '\u0e42\u0e1e\u0e2a\u0e15\u0e4c\u0e44\u0e14\u0e49\u0e27\u0e31\u0e19\u0e25\u0e30\u0e01\u0e35\u0e48\u0e01\u0e25\u0e38\u0e48\u0e21?', a: 'Rookie (\u0e1f\u0e23\u0e35): 10/\u0e27\u0e31\u0e19 \u00b7 Top Agent: 300/\u0e27\u0e31\u0e19 \u00b7 Elite: 750/\u0e27\u0e31\u0e19 \u2014 \u0e23\u0e35\u0e40\u0e0b\u0e47\u0e15\u0e17\u0e38\u0e01\u0e27\u0e31\u0e19 05:00 \u0e19. \u0e14\u0e39\u0e23\u0e32\u0e22\u0e25\u0e30\u0e40\u0e2d\u0e35\u0e22\u0e14\u0e40\u0e1e\u0e34\u0e48\u0e21\u0e40\u0e15\u0e34\u0e21\u0e17\u0e35\u0e48\u0e2b\u0e19\u0e49\u0e32\u0e23\u0e32\u0e04\u0e32' },
                { q: 'AI Caption \u0e17\u0e33\u0e07\u0e32\u0e19\u0e2d\u0e22\u0e48\u0e32\u0e07\u0e44\u0e23?', a: 'Claude AI \u0e2a\u0e23\u0e49\u0e32\u0e07\u0e41\u0e04\u0e1b\u0e0a\u0e31\u0e48\u0e19\u0e20\u0e32\u0e29\u0e32\u0e44\u0e17\u0e22\u0e17\u0e35\u0e48\u0e44\u0e21\u0e48\u0e0b\u0e49\u0e33\u0e01\u0e31\u0e19\u0e2a\u0e33\u0e2b\u0e23\u0e31\u0e1a\u0e41\u0e15\u0e48\u0e25\u0e30\u0e01\u0e25\u0e38\u0e48\u0e21 \u2014 \u0e43\u0e2a\u0e48\u0e23\u0e32\u0e22\u0e25\u0e30\u0e40\u0e2d\u0e35\u0e22\u0e14\u0e2a\u0e34\u0e19\u0e17\u0e23\u0e31\u0e1e\u0e22\u0e4c \u0e23\u0e32\u0e04\u0e32 \u0e17\u0e35\u0e48\u0e15\u0e31\u0e49\u0e07 \u0e41\u0e25\u0e30 hashtag \u0e23\u0e30\u0e1a\u0e1a\u0e08\u0e31\u0e14\u0e01\u0e32\u0e23\u0e43\u0e2b\u0e49\u0e2d\u0e31\u0e15\u0e42\u0e19\u0e21\u0e31\u0e15\u0e34 \u0e44\u0e21\u0e48\u0e15\u0e49\u0e2d\u0e07\u0e15\u0e31\u0e49\u0e07\u0e04\u0e48\u0e32 API Key' },
                { q: '\u0e1a\u0e31\u0e0d\u0e0a\u0e35 Facebook \u0e1b\u0e25\u0e2d\u0e14\u0e20\u0e31\u0e22\u0e44\u0e2b\u0e21?', a: 'Anti-Detection 6 \u0e0a\u0e31\u0e49\u0e19: \u0e2b\u0e19\u0e48\u0e27\u0e07\u0e40\u0e27\u0e25\u0e32\u0e2a\u0e38\u0e48\u0e21, \u0e08\u0e33\u0e25\u0e2d\u0e07\u0e01\u0e32\u0e23\u0e40\u0e04\u0e25\u0e37\u0e48\u0e2d\u0e19\u0e44\u0e2b\u0e27\u0e40\u0e2b\u0e21\u0e37\u0e2d\u0e19\u0e21\u0e19\u0e38\u0e29\u0e22\u0e4c, \u0e1b\u0e25\u0e2d\u0e21 Browser Fingerprint, \u0e41\u0e22\u0e01 Session \u0e15\u0e48\u0e2d\u0e1c\u0e39\u0e49\u0e43\u0e0a\u0e49 \u0e23\u0e30\u0e1a\u0e1a Health Check \u0e15\u0e23\u0e27\u0e08\u0e04\u0e30\u0e41\u0e19\u0e19\u0e04\u0e27\u0e32\u0e21\u0e1b\u0e25\u0e2d\u0e14\u0e20\u0e31\u0e22\u0e41\u0e25\u0e30\u0e41\u0e19\u0e30\u0e19\u0e33\u0e04\u0e27\u0e32\u0e21\u0e16\u0e35\u0e48\u0e43\u0e19\u0e01\u0e32\u0e23\u0e42\u0e1e\u0e2a\u0e15\u0e4c\u0e17\u0e35\u0e48\u0e40\u0e2b\u0e21\u0e32\u0e30\u0e2a\u0e21' },
              ]).map((faq, i) => (
